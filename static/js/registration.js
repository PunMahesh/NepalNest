...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    var contact = document.getElementById("contact-field").value;
    var password1 = document.getElementById("password1-field").value;
    var password2 = document.getElementById("password2-field").value;
    ...
    if (password1.length < 8) {
      document.querySelector(".password1-error").textContent =
        "Password should be at least 8 characters long.";
      return;
    }

    if (password1 !== password2) {
      document.querySelector(".password2-error").textContent =
